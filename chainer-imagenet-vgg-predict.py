...
if __name__ == '__main__':
    ...
    parser.add_argument('--image', type=str, default='image_vase.png')
    ...
    words = open('caffe_ilsvrc12//synset_words.txt').readlines()
    ...
    #chainer.serializers.save_npz('VGG_ILSVRC_19_layers_mitmul.npz', vgg)
